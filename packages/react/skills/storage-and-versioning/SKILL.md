---
name: storage-and-versioning
description: Storage adapters, version management, migrations, and persistence patterns for Flowsterix. Use when configuring tour state persistence, implementing custom storage adapters, handling version migrations, or managing flow state across sessions.
metadata:
  sources:
