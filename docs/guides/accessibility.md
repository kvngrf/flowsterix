...
- During long jumps, Flowsterix fades out the overlay highlight and popover at the current position, scrolls to the new target, then fades them in at the new position — avoiding "flying out of view" artifacts.
